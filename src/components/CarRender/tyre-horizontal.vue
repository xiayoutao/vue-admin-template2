...
.tyre {
	...
	&.is-empty {
		background-image: url('/img/car/tyre-empty-horizontal.png');

		&.is-active {
			background-image: url('/img/car/tyre-empty-horizontal-selected.png');
		}
	}
	&.is-retread {
		background-image: url('/img/car/tyre-horizontal-retread.png');
